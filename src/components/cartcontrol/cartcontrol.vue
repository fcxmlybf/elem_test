...
<style lang="scss">
    .cartcontrol{
        .cart-decrease{
            display:inline-block;padding:6px;transition: all .4s linear;
            .inner{
                line-height:24px;font-size:24px;color:rgb(0,160,220);transition:all 0.4s linear;
            }
            &.fadeRotate-enter-active, &.fadeRotate-leave-active{
                transform:translate3d(0,0,0);
                .inner{display:inline-block;transform:rotate(0);}
            }
